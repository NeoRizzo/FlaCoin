...
"""Verify that starting flacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start flacoin with -h for help text")
        ...
        self.log.info("Start flacoin with -version for version information")
