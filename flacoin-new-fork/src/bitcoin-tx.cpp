...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flacoin transaction") + "\n" +
              "  flacoin-tx [options] -create [commands]   " + _("Create hex-encoded flacoin transaction") + "\n" +
              "\n";
