...
* flacoin.conf: contains configuration settings for flacoind or flacoin-qt
* flacoind.pid: stores the process id of flacoind while running
...
* debug.log: contains debug information and general logging generated by flacoind or flacoin-qt
