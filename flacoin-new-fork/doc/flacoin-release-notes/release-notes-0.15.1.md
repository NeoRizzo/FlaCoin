FlaCoin Core version *0.15.1* is now available from:

  <https://download.flacoin.org/flacoin-0.15.1/>
...
A number of changes to the way FlaCoin Core deals with peer connections and invalid blocks
