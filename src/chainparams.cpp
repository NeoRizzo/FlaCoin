...
{
    const char* pszTimestamp = "fork FlaCoin FLA nova Moeda 08/01/2020 21:49";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xe4364791a63fcc67882ed621edf2b65ad98420ab843ad2a96b8866d08de7fb43"); 
        ...
        genesis = CreateGenesisBlock(1578531056, 1956171, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5ba90916611c79f58f641b71884f4be5119dfa372fc3b138d84cb557b2e87ae2"));
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x599ad283cfb2ef30bd96b75e4bbcecaac2a8062082c57cbd4114d5bab7912d4d"); 
        ...
        genesis = CreateGenesisBlock(1578566531, 281666, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf30b0ba36dc16060b1d158a9704295dc9cc8df81437ffd444b54266763e173e2"));
        assert(genesis.hashMerkleRoot == uint256S("0xb75da2a6bf1b053a72aaa5057cfef5281ccb6e00c47dc7130668ca0571e00e8f"));
        ...
        chainTxData = ChainTxData{
            // Data as of block 599ad283cfb2ef30bd96b75e4bbcecaac2a8062082c57cbd4114d5bab7912d4d (height 0)
            1578566531,
            0,
            0
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1578566749, 82472, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x668ebfc71546667fdc7cdd6e641754f6a4a202d716dd3447edd5a069501d4d7c"));
        assert(genesis.hashMerkleRoot == uint256S("0xb75da2a6bf1b053a72aaa5057cfef5281ccb6e00c47dc7130668ca0571e00e8f"));
