...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 16499
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 16500
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 21587
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 21588
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 16499
	%{_sbindir}/semanage port -d -p tcp 16500
	%{_sbindir}/semanage port -d -p tcp 21587
	%{_sbindir}/semanage port -d -p tcp 21588
